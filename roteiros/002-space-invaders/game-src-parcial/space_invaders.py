...
class SpaceInvaders:
    def __init__(self):
        ...
        self._inimigo = Inimigo(
            posicao=Vetor2D(
                (ConfigJogo.DIM_TELA.x - ConfigJogo.TAM_INIMIGO.x) // 2,
                int(ConfigJogo.DIM_TELA.y * 0.1)),
        ...
        self._cron_espera_tiro_inimigo = Cronometro()
    ...
    def desenha(self):
        ...
        self._inimigo.desenha(self._tela)
    ...
    def _cria_tiro_inimigo(self):
        inimigo = self._inimigo
