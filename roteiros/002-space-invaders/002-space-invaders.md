...
**Classes do Projeto**: Analisando a tela do jogo podemos identificar alguns tipos de objetos como o jato do jogador, as naves inimigas e os tiros. Estes tipos de objetos virarão classes em nosso projeto. Além destas, utilizaremos classes  auxiliares Vetor2D e Cronometro. Por fim, criaremos uma classe para representar o jogo e esta classe será responsável por coordenar os objetos do jogo e suas interações, além de gerenciar a pontuação da partida.
...
Vamos começar criando uma única nave inimiga. Mais à frente vamos implementar o enxame de inimigos. Implemente a classe Inimigo em inimigo.py usando a mesma lógica da classe Jato. Em seguida:
...
Crie um arquivo tiro.py e nele crie a classe Tiro.
